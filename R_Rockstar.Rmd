...
arbuthnot$boys # I want to see the the data frame where I see all values of # boys that were baptized. This is a vector which has a set of values, They are not structured in a table
arbuthnot$girls # I want to see the the data frame where I see all values of # girls that were baptized. This is a vector which has a set of values They are not structured in a table
